...
public class HeletrecmadcrafterProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				UsefuldnsMod.LOGGER.warn("Failed to load dependency entity for procedure Heletrecmadcrafter!");
			return;
		}
		...
		if (entity instanceof PlayerEntity) {
			...
			if (_current instanceof Supplier) {
				Object invobj = ((Supplier) _current).get();
				if (invobj instanceof Map) {
					ItemStack _setstack = new ItemStack(UnboingotItem.block);
					_setstack.setCount((int) 1);
		...
		if (entity instanceof PlayerEntity) {
			...
			if (_current instanceof Supplier) {
				Object invobj = ((Supplier) _current).get();
				if (invobj instanceof Map) {
					ItemStack _setstack = new ItemStack(UnobtainiumItem.helmet);
					_setstack.setCount((int) 1);
