...
public class LiquidtofeUpdateTickProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == (LiquidRFBlock.block instanceof FlowingFluidBlock
		...
		if (!world.isRemote()) {
			...
			if (_tileEntity != null)
				_tileEntity.getTileData().putDouble("liqfe1", (new Object() {
					public int getEnergyStored(IWorld world, BlockPos pos) {
						AtomicInteger _retval = new AtomicInteger(0);
						TileEntity _ent = world.getTileEntity(pos);
						if (_ent != null)
		...
		if (!world.isRemote()) {
			...
			BlockState _bs = world.getBlockState(_bp);
			if (_tileEntity != null)
				_tileEntity.getTileData().putDouble("liqfe2", (new Object() {
					public int getFluidTankLevel(BlockPos pos, int tank) {
						AtomicInteger _retval = new AtomicInteger(0);
						TileEntity _ent = world.getTileEntity(pos);
						if (_ent != null)
