...
public class PostionsProjectorUpdateTickProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == ModnightvisionItem.block)) {
			if (((Entity) world
				...
				((LivingEntity) ((Entity) world
						...
						.stream().sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								...
								.addPotionEffect(new EffectInstance(DiamondpoopsPotionEffect.potion, (int) 120, (int) 1, (false), (false)));
		}
		if (((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == ModregenItem.block)) {
			if (((Entity) world
					.getEntitiesWithinAABB(PlayerEntity.class,
							new AxisAlignedBB(x - (50 / 2d), y - (50 / 2d), z - (50 / 2d), x + (50 / 2d), y + (50 / 2d), z + (50 / 2d)), null)
					.stream().sorted(new Object() {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (3))).getItem() == ModsaturationItem.block)) {
			if (((Entity) world
					.getEntitiesWithinAABB(PlayerEntity.class,
							new AxisAlignedBB(x - (50 / 2d), y - (50 / 2d), z - (50 / 2d), x + (50 / 2d), y + (50 / 2d), z + (50 / 2d)), null)
					.stream().sorted(new Object() {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (4))).getItem() == ModspeedItem.block)) {
			if (((Entity) world
					.getEntitiesWithinAABB(PlayerEntity.class,
							new AxisAlignedBB(x - (50 / 2d), y - (50 / 2d), z - (50 / 2d), x + (50 / 2d), y + (50 / 2d), z + (50 / 2d)), null)
					.stream().sorted(new Object() {
				...
				((LivingEntity) ((Entity) world
						...
						.stream().sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								...
								.addPotionEffect(new EffectInstance(Effects.SPEED, (int) 120, (int) 5, (false), (false)));
		}
	}
}
