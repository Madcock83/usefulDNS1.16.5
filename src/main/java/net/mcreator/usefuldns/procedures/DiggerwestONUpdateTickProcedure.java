...
import net.mcreator.usefuldns.block.DiggerwestONBlock;
import net.mcreator.usefuldns.block.DiggerWestBlock;
import net.mcreator.usefuldns.UsefuldnsMod;

import java.util.Map;
import java.util.HashMap;

public class DiggerwestONUpdateTickProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				UsefuldnsMod.LOGGER.warn("Failed to load dependency x for procedure DiggerwestONUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				UsefuldnsMod.LOGGER.warn("Failed to load dependency y for procedure DiggerwestONUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				UsefuldnsMod.LOGGER.warn("Failed to load dependency z for procedure DiggerwestONUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				UsefuldnsMod.LOGGER.warn("Failed to load dependency world for procedure DiggerwestONUpdateTick!");
			return;
		}
		...
		if (((world.getBlockState(new BlockPos((int) (x - 1), (int) y, (int) z))).getBlock() == Blocks.BEDROCK)) {
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Blocks.AIR.getDefaultState(), 3);
			{
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				BlockState _bs = DiggerWestBlock.block.getDefaultState();
			...
			if (((world.getLight(new BlockPos((int) (x + 1), (int) y, (int) z))) <= 9)) {
				{
			...
			}
			{
				...
				LavaCheckWestProcedure.executeProcedure($_dependencies);
			}
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("x", x);
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				FillBlockWestProcedure.executeProcedure($_dependencies);
			}
			...
			if (world instanceof World) {
				Block.spawnDrops(world.getBlockState(new BlockPos((int) (x - 1), (int) (y + 2), (int) z)), (World) world,
						new BlockPos((int) (x - 1), (int) y, (int) z));
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Blocks.AIR.getDefaultState(), 3);
			{
				...
				BlockState _bs = DiggerwestONBlock.block.getDefaultState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateContainer().getProperty(entry.getKey().getName());
					if (_property != null && _bs.get(_property) != null)
