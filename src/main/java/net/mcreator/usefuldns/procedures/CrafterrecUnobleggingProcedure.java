...
public class CrafterrecUnobleggingProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				UsefuldnsMod.LOGGER.warn("Failed to load dependency x for procedure CrafterrecUnoblegging!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				UsefuldnsMod.LOGGER.warn("Failed to load dependency y for procedure CrafterrecUnoblegging!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				UsefuldnsMod.LOGGER.warn("Failed to load dependency z for procedure CrafterrecUnoblegging!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				UsefuldnsMod.LOGGER.warn("Failed to load dependency world for procedure CrafterrecUnoblegging!");
			return;
		}
		...
		if ((((((((new Object() {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (7))).getItem() == ReinfdiaplaterItem.block)))) && (((((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (25))).getItem() == UnobtainiumItem.legs)))))) {
			{
			...
			}
			{
				...
				if (_ent != null) {
					...
					final ItemStack _setstack = new ItemStack(UnobtainiumItem.legs);
