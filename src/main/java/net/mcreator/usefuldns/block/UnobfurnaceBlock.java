...
public class UnobfurnaceBlock extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:unobfurnace")
	public static final Block block = null;
	@ObjectHolder("usefuldns:unobfurnace")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public UnobfurnaceBlock(UsefuldnsModElements instance) {
		super(instance, 58);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("unobfurnace"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				UnobfurancesmeltProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("unobfurnace");
		}
