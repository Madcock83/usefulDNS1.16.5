...
import net.mcreator.usefuldns.procedures.LiquidRFMobplayerColidesBlockProcedure;
...
public class LiquidRFBlock extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:liquid_rf")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("usefuldns:liquid_rf_bucket")
	...
	public void initElements() {
		...
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("liquid_rf_flowing");
		elements.blocks
				.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.WATER).hardnessAndResistance(100f).setLightLevel(s -> 0)) {
					...
					public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
						...
						int z = pos.getZ();
						{
							...
							LiquidRFMobplayerColidesBlockProcedure.executeProcedure($_dependencies);
						}
					}
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new LakesFeature(BlockStateFeatureConfig.field_236455_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random rand, BlockPos pos, BlockStateFeatureConfig config) {
					...
					if (dimensionType == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("usefuldns:madsworld")))
			...
			event.getRegistry().register(feature.setRegistryName("liquid_rf_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("usefuldns:liquid_rf_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
