...
import net.mcreator.usefuldns.procedures.CompressedcoalBlockDestroyedByExplosionProcedure;
...
public class CompressedcoalBlock extends UsefuldnsModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public void onExplosionDestroy(World world, BlockPos pos, Explosion e) {
			...
			int z = pos.getZ();
			{
				...
				CompressedcoalBlockDestroyedByExplosionProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
