...
public class OctupleblockBlock extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:octupleblock")
	public static final Block block = null;
	public OctupleblockBlock(UsefuldnsModElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GROUND).hardnessAndResistance(2f, 10f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("octupleblock");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("This is a debug block. Has no use"));
		}
