...
import net.mcreator.usefuldns.procedures.EscapeOnBlockRightClickedshiftProcedure;
...
public class EscapeBlock extends UsefuldnsModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Shift+Right Click to start digging"));
			list.add(new StringTextComponent("Right click to change"));
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				EscapeOnBlockRightClickedshiftProcedure.executeProcedure($_dependencies);
			}
