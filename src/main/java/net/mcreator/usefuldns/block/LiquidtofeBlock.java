...
import net.mcreator.usefuldns.procedures.LiquidtofeUpdateTickProcedure;
import net.mcreator.usefuldns.itemgroup.UsefuldnsItemGroup;
import net.mcreator.usefuldns.gui.LiquidtofeguiGui;
...
public class LiquidtofeBlock extends UsefuldnsModElements.ModElement {
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("liquidtofe"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("This Machine takes in Liguid FE"));
			list.add(new StringTextComponent("and converts it to FE"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Liquid to FE Transformer");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new LiquidtofeguiGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("liquidtofe");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new LiquidtofeguiGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
		...
		private final EnergyStorage energyStorage = new EnergyStorage(100000000, 10000000, 1000000, 0) {
			@Override
