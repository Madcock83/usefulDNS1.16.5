...
public class UnobmixItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:unobmix")
	public static final Item block = null;
	public UnobmixItem(UsefuldnsModElements instance) {
		super(instance, 6);
	}
