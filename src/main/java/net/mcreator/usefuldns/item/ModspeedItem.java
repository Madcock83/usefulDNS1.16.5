...
public class ModspeedItem extends UsefuldnsModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Speeds your slow-self up"));
			list.add(new StringTextComponent("Consumes 3 FE/tick"));
		}
	}
}
