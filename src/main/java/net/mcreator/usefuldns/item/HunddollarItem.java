...
public class HunddollarItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:hunddollar")
	public static final Item block = null;
	public HunddollarItem(UsefuldnsModElements instance) {
		super(instance, 17);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Thats a nice hunny"));
		}
	}
}
