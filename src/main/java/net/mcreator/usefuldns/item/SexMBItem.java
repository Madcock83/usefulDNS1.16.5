...
public class SexMBItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:sex_mb")
	public static final Item block = null;
	public SexMBItem(UsefuldnsModElements instance) {
		super(instance, 26);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Holy Cow"));
		}
	}
}
