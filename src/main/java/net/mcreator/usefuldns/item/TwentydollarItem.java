...
public class TwentydollarItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:twentydollar")
	public static final Item block = null;
	public TwentydollarItem(UsefuldnsModElements instance) {
		super(instance, 16);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Action Jackson"));
		}
	}
}
