...
public class ModregenItem extends UsefuldnsModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Regenerates Hearts"));
			list.add(new StringTextComponent("Consumes 5 FE/tick"));
		}
	}
}
