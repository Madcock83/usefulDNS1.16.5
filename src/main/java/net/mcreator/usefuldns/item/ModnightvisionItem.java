...
public class ModnightvisionItem extends UsefuldnsModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("modnightvision");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Gives you Night Vision"));
			list.add(new StringTextComponent("Consumes 2 FE/tick"));
		}
	}
}
