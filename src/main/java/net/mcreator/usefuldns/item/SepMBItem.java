...
public class SepMBItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:sep_mb")
	public static final Item block = null;
	public SepMBItem(UsefuldnsModElements instance) {
		super(instance, 27);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Blood Money!!!!"));
		}
	}
}
