...
public class FivedollarItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:fivedollar")
	public static final Item block = null;
	public FivedollarItem(UsefuldnsModElements instance) {
		super(instance, 14);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Have you met me friend Lincoln?"));
		}
	}
}
