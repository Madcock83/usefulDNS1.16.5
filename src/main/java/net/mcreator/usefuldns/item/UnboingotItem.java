...
public class UnboingotItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:unboingot")
	public static final Item block = null;
	public UnboingotItem(UsefuldnsModElements instance) {
		super(instance, 7);
	}
