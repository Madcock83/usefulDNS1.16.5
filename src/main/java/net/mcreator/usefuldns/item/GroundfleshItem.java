...
public class GroundfleshItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:groundflesh")
	public static final Item block = null;
	public GroundfleshItem(UsefuldnsModElements instance) {
		super(instance, 10);
	}
