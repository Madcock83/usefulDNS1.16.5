...
public class OctupleMBItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:octuple_mb")
	public static final Item block = null;
	public OctupleMBItem(UsefuldnsModElements instance) {
		super(instance, 28);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("ALL THE MONEY THERE IS!"));
		}
	}
}
