...
public class RawironItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:rawiron")
	public static final Item block = null;
	public RawironItem(UsefuldnsModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Swiss Army Knife iron ore to get this!"));
		}
	}
}
