...
public class QuinmbItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:quinmb")
	public static final Item block = null;
	public QuinmbItem(UsefuldnsModElements instance) {
		super(instance, 25);
	}
