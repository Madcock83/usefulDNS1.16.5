...
public class TimeupgradeItem extends UsefuldnsModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Locks Time at Noon"));
			list.add(new StringTextComponent("Comsumes 100 FE/tick"));
		}
	}
}
