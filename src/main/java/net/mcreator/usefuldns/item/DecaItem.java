...
public class DecaItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:deca")
	public static final Item block = null;
	public DecaItem(UsefuldnsModElements instance) {
		super(instance, 5);
	}
