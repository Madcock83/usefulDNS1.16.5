...
public class DeathupgradeItem extends UsefuldnsModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Upgrade deal Damage to Hostile Mobs"));
			list.add(new StringTextComponent("Consumes 25 Fe/tick"));
		}
	}
}
