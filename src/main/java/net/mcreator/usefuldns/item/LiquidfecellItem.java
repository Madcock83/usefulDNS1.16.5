...
public class LiquidfecellItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:liquidfecell")
	public static final Item block = null;
	public LiquidfecellItem(UsefuldnsModElements instance) {
		super(instance, 278);
	}
