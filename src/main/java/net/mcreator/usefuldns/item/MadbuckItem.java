...
public class MadbuckItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:madbuck")
	public static final Item block = null;
	public MadbuckItem(UsefuldnsModElements instance) {
		super(instance, 29);
	}
