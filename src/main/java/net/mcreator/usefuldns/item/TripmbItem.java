...
public class TripmbItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:tripmb")
	public static final Item block = null;
	public TripmbItem(UsefuldnsModElements instance) {
		super(instance, 23);
	}
