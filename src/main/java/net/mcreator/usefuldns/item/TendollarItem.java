...
public class TendollarItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:tendollar")
	public static final Item block = null;
	public TendollarItem(UsefuldnsModElements instance) {
		super(instance, 15);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Dimebag"));
		}
	}
}
