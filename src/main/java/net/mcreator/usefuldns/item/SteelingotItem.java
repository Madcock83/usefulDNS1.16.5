...
public class SteelingotItem extends UsefuldnsModElements.ModElement {
	@ObjectHolder("usefuldns:steelingot")
	public static final Item block = null;
	public SteelingotItem(UsefuldnsModElements instance) {
		super(instance, 3);
	}
